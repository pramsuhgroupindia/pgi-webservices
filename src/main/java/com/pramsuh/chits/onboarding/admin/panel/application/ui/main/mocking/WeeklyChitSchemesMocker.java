...
public class WeeklyChitSchemesMocker {
    ...
    public void mockWeeklySchemesTableData(WeeklyAuctionableDurationsRepository weeklyAuctionableDurationsRepository, WeeklyChitGroupsRepository weeklyChitGroupsRepository ){
        ...
        mockWeeklyChitGroups120(weeklyChitGroupsRepository);
        mockWeeklyChitGroups140(weeklyChitGroupsRepository);
        mockWeeklyChitGroups160(weeklyChitGroupsRepository);
        mockWeeklyChitGroups180(weeklyChitGroupsRepository);
        mockWeeklyChitGroups200(weeklyChitGroupsRepository);
    }
    ...
    private void mockWeeklyChitGroups10(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMTotalNumberOfTickets("10");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("9");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("9");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("0% of Chit Value");
        weeklyChitGroups1.setMaxBidRange("20% of Chit Value");
        weeklyChitGroups1.setMinPrizeRange("40,000 Rs");
        weeklyChitGroups1.setMaxPrizeRange("50,000 Rs");
        weeklyChitGroups1.setMTotalNumberOfAgreementsSigned("0");
        ...
        weeklyChitGroups1.setNoofguaranters("0");
    ...
    private void mockWeeklyChitGroups15(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        ob1.setMinBidRange("TO BE DECIDED");
        ob1.setMaxBidRange("TO BE DECIDED");
        ob1.setMinPrizeRange("TO BE DECIDED");
        ob1.setMaxPrizeRange("TO BE DECIDED");
        ...
        ob1.setSubscription("TO BE DECIDED");
        ob1.setDividend("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups20(WeeklyChitGroupsRepository weeklyChitGroupsRepository ){
        ...
        weeklyChitGroups1.setMTotalNumberOfTickets("20");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("12");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("7");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("19");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("7");
        weeklyChitGroups1.setMBookingStatus("OPEN");
        weeklyChitGroups1.setMinBidRange("0% of Chit Value");
        weeklyChitGroups1.setMaxBidRange("25% of Chit Value");
        weeklyChitGroups1.setMinPrizeRange("37,500 Rs");
        weeklyChitGroups1.setMaxPrizeRange("50,000 Rs");
        weeklyChitGroups1.setMTotalNumberOfAgreementsSigned("7");
        ...
        weeklyChitGroups1.setTime("TO BE DECIDED");
        ...
        weeklyChitGroups2.setMTotalNumberOfTickets("20");
        weeklyChitGroups2.setMTotalNumberOfAvailableTickets("19");
        weeklyChitGroups2.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups2.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups2.setMTotalNumberOfAuctions("19");
        weeklyChitGroups2.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups2.setMBookingStatus("SCHEDULED");
        weeklyChitGroups2.setMinBidRange("0% of Chit Value");
        weeklyChitGroups2.setMaxBidRange("25% of Chit Value");
        weeklyChitGroups2.setMinPrizeRange("37,500 Rs");
        weeklyChitGroups2.setMaxPrizeRange("50,000 Rs");
        weeklyChitGroups2.setMTotalNumberOfAgreementsSigned("0");
        ...
        weeklyChitGroups2.setTime("TO BE DECIDED");
        ...
        weeklyChitGroups2.setNoofguaranters("0");
    ...
    private void mockWeeklyChitGroups25(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("25");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("24");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("24");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("0% of Chit Value");
        weeklyChitGroups1.setMaxBidRange("25% of Chit Value");
        weeklyChitGroups1.setMinPrizeRange("37,500 Rs");
        weeklyChitGroups1.setMaxPrizeRange("50,000 Rs");
        weeklyChitGroups1.setMTotalNumberOfAgreementsSigned("4");
    ...
    private void mockWeeklyChitGroups30(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("30");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("29");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("29");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMinPrizeRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxPrizeRange("TO BE DECIDED");
        weeklyChitGroups1.setMTotalNumberOfAgreementsSigned("4");
        ...
        weeklyChitGroups1.setDistribution("Every Wednesday of Week");
        weeklyChitGroups1.setFrequency("WEEKLY 1 AUCTION");
        weeklyChitGroups1.setSubscription("TO BE DECIDED");
        weeklyChitGroups1.setDividend("TO BE DECIDED");
        weeklyChitGroups1.setMethod("LUCKY DRAW ON COMPANY MOBILE APP");
        weeklyChitGroups1.setEfees("1% OF CHIT VALUE(500 INR PER TICKET)");
        weeklyChitGroups1.setPaymentfrequency("DAILY, WEEKLY, BIWEEKLY");
        weeklyChitGroups1.setNoofguaranters("0");
    ...
    private void mockWeeklyChitGroups40(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("40");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("39");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("39");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups50(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("50");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("49");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("49");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups60(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("60");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("59");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("59");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups70(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("70");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("69");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("69");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups80(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("80");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("79");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("79");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups90(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("90");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("89");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("89");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups100(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("100");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("99");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("99");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups120(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("120");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("119");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("119");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups140(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("140");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("139");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("139");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups160(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("160");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("159");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("159");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups180(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("180");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("179");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("179");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
    ...
    private void mockWeeklyChitGroups200(WeeklyChitGroupsRepository weeklyChitGroupsRepository ) {
        ...
        weeklyChitGroups1.setMVisibility("0");
        weeklyChitGroups1.setMTotalNumberOfTickets("200");
        weeklyChitGroups1.setMTotalNumberOfAvailableTickets("199");
        weeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        weeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        weeklyChitGroups1.setMTotalNumberOfAuctions("199");
        weeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        weeklyChitGroups1.setMBookingStatus("SCHEDULED");
        weeklyChitGroups1.setMinBidRange("TO BE DECIDED");
        weeklyChitGroups1.setMaxBidRange("TO BE DECIDED");
