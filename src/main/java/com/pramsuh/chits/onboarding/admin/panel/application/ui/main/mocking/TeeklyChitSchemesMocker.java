...
public class TeeklyChitSchemesMocker {
    ...
    private void mockTeeklyChitGroups50(TeeklyChitGroupsRepository teeklyChitGroupsRepository) {
        ...
        teeklyChitGroups1.setMTotalNumberOfTickets("50");
        teeklyChitGroups1.setMTotalNumberOfAvailableTickets("49");
        teeklyChitGroups1.setMTotalNumberOfBookedTickets("0");
        teeklyChitGroups1.setMTotalNumberOfVacantTickets("0");
        teeklyChitGroups1.setMTotalNumberOfAuctions("49");
        teeklyChitGroups1.setMTotalNumberOfTicketsSold("0");
        teeklyChitGroups1.setMBookingStatus("Booking: SCHEDULED");
        teeklyChitGroups1.setMinBidRange("0% of Chit Value");
        teeklyChitGroups1.setMaxBidRange("25% of Chit Value");
        teeklyChitGroups1.setMinPrizeRange("37,500 Rs");
        teeklyChitGroups1.setMaxPrizeRange("50,000 Rs");
        teeklyChitGroups1.setMTotalNumberOfAgreementsSigned("4");
        ...
        teeklyChitGroups1.setNoofguaranters("0");
