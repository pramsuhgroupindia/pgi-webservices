...
@RestController
@RequestMapping("/api/v1/chit/funds/web/services/auctionable/schemes/durations/teekly/amounts")
...
//    }
    ...
    @PostMapping
    public ResponseEntity<TeeklyChitGroups> createTeeklyChitGroup(@RequestBody TeeklyChitGroups object){
        object.setNow(LocalDateTime.now());
        if(teeklyChitGroupsRepository.findChitGroupByCode(object.getCode()) == null) {
            TeeklyChitGroups teeklyChitGroups1 = teeklyChitGroupsRepository.save(object);
            if(teeklyChitGroups1 != null) {
                ...
                return new ResponseEntity<TeeklyChitGroups>(object, HttpStatus.OK);
            } else{
                return new ResponseEntity<TeeklyChitGroups>(object, HttpStatus.BAD_REQUEST);
            }
        } else {
            return new ResponseEntity<TeeklyChitGroups>(object, HttpStatus.ALREADY_REPORTED);
        }
    }
}
