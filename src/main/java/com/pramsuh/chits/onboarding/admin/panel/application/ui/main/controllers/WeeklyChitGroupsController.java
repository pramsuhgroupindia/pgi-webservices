...
//    }
    ...
    @PostMapping
    public ResponseEntity<WeeklyChitGroups> createWeeklyChitGroup(@RequestBody WeeklyChitGroups object){
        object.setNow(LocalDateTime.now());
        if(weeklyChitGroupsRepository.findChitGroupByCode(object.getCode()) == null) {
            WeeklyChitGroups weeklyChitGroups1 = weeklyChitGroupsRepository.save(object);
            if(weeklyChitGroups1 != null) {
                ...
                return new ResponseEntity<WeeklyChitGroups>(object, HttpStatus.OK);
            } else{
                return new ResponseEntity<WeeklyChitGroups>(object, HttpStatus.BAD_REQUEST);
            }
        } else {
            return new ResponseEntity<WeeklyChitGroups>(object, HttpStatus.ALREADY_REPORTED);
        }
    }
}
