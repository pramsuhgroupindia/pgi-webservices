...
@RestController
@RequestMapping("/api/v1/hoogmatic/financial/web/services/borrower/files/downloading")
public class HBCustomerFileDownloadController {

    private static final Logger logger = LoggerFactory.getLogger(HBCustomerFileDownloadController.class);
