...
@RestController
@RequestMapping("/api/v1/chit/funds/web/services/auctionable/schemes/durations/bidaily/amounts")
...
//    }
    ...
    @PostMapping
    public ResponseEntity<BiDailyChitGroups> createBiDailyChitGroup(@RequestBody BiDailyChitGroups object){
        object.setNow(LocalDateTime.now());
        if(biDailyChitGroupsRepository.findChitGroupByCode(object.getCode()) == null) {
            BiDailyChitGroups biDailyChitGroups1 = biDailyChitGroupsRepository.save(object);
            if(biDailyChitGroups1 != null) {
                ...
                return new ResponseEntity<BiDailyChitGroups>(object, HttpStatus.OK);
            } else{
                return new ResponseEntity<BiDailyChitGroups>(object, HttpStatus.BAD_REQUEST);
            }
        } else {
            return new ResponseEntity<BiDailyChitGroups>(object, HttpStatus.ALREADY_REPORTED);
        }
    }
}
